...
{
    class OnlyVariablesIntFunctionsTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        /// <summary>
        /// Correct Tests on expressions, which inclide variables (type "int" only) and functions.
        /// 
        /// in these tests:
        /// isCorrectTree = true
        /// testData != null
        ...
        public void OneFunctionCorrectTest()
        {
            ...
            string testExpression = "negative(aa)";
        ...
        public void NumberAndOneFunctionCorrectTest()
        {
            ...
            testData.AddVariable("aa", "int", "6");

            string testExpression = "summ(a, aa) + 3";
        ...
        public void FunctionsExprOpExprCorrectTest()
        {
            ...
            testData.AddVariable("a", "int", "4");
            testData.AddVariable("aa", "int", "36");
            testData.AddVariable("aaa", "int", "2");

            string testExpression = "summ(a, aa) / times10(aaa)";
        ...
        public void FunctionsParenCorrectTest()
        {
            ...
            string testExpression = "summ(a, aa) * (times10(A) - 4)";
        ...
        public void OneFunctionNegativeParameterCorrectTest()
        {
            ...
            string testExpression = "negative(-a)";
        ...
        public void OneFunctionExpressionParameterCorrectTest()
        {
            ...
            string testExpression = "negative(a + aa)";
        ...
        public void OneFunctionExpressionsParametersCorrectTest()
        {
            ...
            testData.AddVariable("aa", "int", "4");
            testData.AddVariable("aaa", "int", "16");

            string testExpression = "summ(a * aa, aaa / 4)";
        ...
        public void FunctionsFunctionParameterCorrectTest()
        {
            ...
            string testExpression = "negative(negative(a))";
        ...
        public void FunctionsFunctionsParametersCorrectTest()
        {
            ...
            string testExpression = "summ(negative(a), negative(aa))";
