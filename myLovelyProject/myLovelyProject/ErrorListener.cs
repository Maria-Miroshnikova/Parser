    ...
    public class ErrorListener<S> : ConsoleErrorListener<S>
    {
            ...
            int col, string msg, RecognitionException e)
        {
            ...
            if (_first_time)
            {
                ...
                List<string> result = new List<string>(); // хочется проверять именно result и col-line
                ...
                if (result.Any())
                {
                    throw new ParseCanceledException(SpecialFunctions.makeErrorMessage(line, col, result));
                }
